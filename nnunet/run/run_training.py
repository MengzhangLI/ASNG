...
if __name__ == "__main__":
    ...
    parser.add_argument("--lam", type=int, required=False, default=2, help="the num of sampling")
    parser.add_argument("--gpu", type=str, default="0", help="the id of gpu used") #"0,1"
    parser.add_argument("--save_dir", required=False, default="./Experiments", help="the directory that you save your experiments logs")
    ...
    trainer = trainer_class(plans_file, fold, output_folder=output_folder_name, dataset_directory=dataset_directory,
                            ...
                            fp16=fp16, lam=args.lam, gpu=args.gpu, save_dir=args.save_dir)
